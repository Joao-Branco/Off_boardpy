...
########
    ...
    # Creates a subscriber for control surface values
    control_surface_sub = rospy.Subscriber(uav_id + "/actuator_control", ActuatorControl, control_surface_cb)
...
######
def control_surface_cb(data):
    global hil_controls
    hil_controls = data
    #aileron = hil_controls.roll_ailerons
    #rudder = hil_controls.yaw_rudder
    #elevator = hil_controls.pitch_elevator
######
